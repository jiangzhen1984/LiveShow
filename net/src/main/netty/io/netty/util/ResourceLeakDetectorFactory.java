    ...
    private static final class DefaultResourceLeakDetectorFactory extends ResourceLeakDetectorFactory {
        ...
        DefaultResourceLeakDetectorFactory() {
            ...
            try {
                ...
                Log.e("","Could not access System property: io.netty.customResourceLeakDetector", cause);
        ...
        private static Constructor<?> customClassConstructor(String customLeakDetector) {
            try {
                ...
                if (ResourceLeakDetector.class.isAssignableFrom(detectorClass)) {
                    ...
                    Log.e("","Class {} does not inherit from ResourceLeakDetector."+ customLeakDetector);
                }
            } catch (Throwable t) {
                Log.e("","Could not load custom resource leak detector class provided: {}"+
