...
public class DefaultPromise<V> extends AbstractFuture<V> implements Promise<V> {
    ...
    private static void notifyListener0(Future future, GenericFutureListener l) {
        try {
            ...
            Log.w("DefaultPromise","An exception was thrown by " + l.getClass().getName() + ".operationComplete()", t);
        }
    }
    ...
    private static void notifyProgressiveListener0(
        ...
        try {
            ...
            Log.w("DefaultPromise","An exception was thrown by " + l.getClass().getName() + ".operationProgressed()", t);
        }
    }
    ...
    private static void safeExecute(EventExecutor executor, Runnable task) {
        try {
            ...
            Log.e("DefaultPromise","Failed to submit a listener notification task. Event loop shut down?", t);
        }
    }
}
