        ...
        synchronized (ThreadLocalRandom.class) {
            ...
            for (;;) {
                ...
                try {
                    ...
                    interrupted = true;
                    Log.w("ThreadLocalRandom","Failed to generate a seed from SecureRandom due to an InterruptedException.");
                    break;
                }

                if (waitTime <= 0) {
                    seedGeneratorThread.interrupt();
                    Log.w("ThreadLocalRandom","Failed to generate a seed from SecureRandom within {} seconds. " +
