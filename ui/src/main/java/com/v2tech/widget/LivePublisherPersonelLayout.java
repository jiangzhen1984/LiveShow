...
public class LivePublisherPersonelLayout extends LinearLayout {
    ...
    public void addView(View child, int index,
        ...
        switch (id) {
            ...
            case R.id.publisher_personel_btn_layout:
                ...
                chattingBtn = child.findViewById(R.id.p2p_audio_connection_watcher_btn_layout_chatting_btn);
                tipsBtn = child.findViewById(R.id.p2p_audio_connection_watcher_btn_layout_tips_btn);
                ...
                chattingBtn.setOnTouchListener(touchListener);
                break;
    ...
    public OnTouchListener touchListener = new OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            if (outListener == null && v != chattingBtn) {
                return false;
            }
            int action = event.getAction();
            switch(action) {
                case MotionEvent.ACTION_DOWN:
                    outListener.onAudioBtnPressed(v);
                    break;
                case MotionEvent.ACTION_UP:
                    outListener.onAudioBtnReleased(v);
                    break;
            }
            return false;
        }
